...
<!--          <button type="button" class="px-5 py-2 font-medium rounded-full" :class="[countries == country.url ? 'bg-[#D6DD85] text-primary':'bg-gray-50 text-gray-800']" @click="countries = country.url" v-for="country in listCountry">{{country.nombre}}</button>-->
<!--        </div>-->
<!--      </div>-->
<!--  </section>-->
