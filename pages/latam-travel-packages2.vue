<template>
  ...
  <section class="my-12">
    ...
    <div class="container grid grid-cols-4 gap-12">
        ...
        <a :href="'/peru-travel-packages/'+packages.url" class="mx-3 p-3 bg-white w-full rounded-xl my-2 shadow-md cursor-pointer" v-for="packages in listPackages" :key="packages.id">
          <div class="relative">
