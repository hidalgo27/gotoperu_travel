...
<template>
  <div class="w-full">
    ...
    <div class="mt-6 hidden md:block">
      <nav class="gap-6 hidden md:flex flex-row item-center justify-center text-start">
        ...
        <ClientOnly>
          <Dropdown ref="dropdownRef">
            ...
            <template #popper="{ hide }">
              <div
                class="v-popper 2xl:w-[70vh] p-6 lg:h-96 lg:min-h-96  h-[32rem] min-h-[32rem] bg-white text-gray-800 rounded-t-md md:rounded-md  md:w-[80vh] lg:w-[100vh] flex md:flex-col lg:flex-row gap-6 text-sm">
                <div class="w-full ">
