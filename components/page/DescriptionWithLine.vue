...
<!--    </svg>-->
    <div class="w-1/2">
      <svg viewBox="0 0 830 208" class="absolute right-0 top-3 hidden md:flex md:w-1/3 lg:w-1/2 overflow-visible">
        <path class="animatedSvg text-secondary" fill="none" stroke="currentColor" stroke-dasharray=".1 7" stroke-linecap="round" stroke-width="1.3" d="M828.83 45.367C785.225 29.412 741.933 5.495 695.441 2.375 631.754-1.9 585.635 27.83 543.083 60.646c-30.253 23.33-62.846 44.691-94.447 66.708-40.774 28.409-81.521 56.592-134.048 69.847-52.768 13.315-111.636 9.665-168.236 3.141-32.471-3.742-70.003-11.736-101.17-23.139"></path>
<!--        <path class="animatedSvg" fill="none" stroke="#fff" stroke-width="3" stroke-dasharray="8" stroke-dashoffset="1696" d="M828.83 45.367C785.225 29.412 741.933 5.495 695.441 2.375 631.754-1.9 585.635 27.83 543.083 60.646c-30.253 23.33-62.846 44.691-94.447 66.708-40.774 28.409-81.521 56.592-134.048 69.847-52.768 13.315-111.636 9.665-168.236 3.141-32.471-3.742-70.003-11.736-101.17-23.139"></path>-->
        <g class="g-svg">
          <path d="M53.2705 173.306C48.8573 185.805 35.1476 192.359 22.649 187.946C10.1505 183.533 3.59599 169.823 8.00919 157.325C12.4224 144.826 26.1321 138.272 38.6307 142.685C51.1292 147.098 57.6837 160.808 53.2705 173.306Z" fill="#FDEEE9" fill-opacity="0.4"></path>
          <path d="M34.4116 166.647C33.6761 168.731 31.3911 169.823 29.3081 169.087C27.225 168.352 26.1325 166.067 26.8681 163.984C27.6036 161.901 29.8886 160.808 31.9717 161.544C34.0548 162.279 35.1472 164.564 34.4116 166.647Z" fill="#F05B2A"></path>
        </g>
      </svg>
    </div>
...
<!--    </div>-->
    ...
    <div class="text-center grid space-y-3">
      ...
      <p class="mt-4 animatedDiv"> Our adventures are tailored to meet a variety of fitness levels so you can pick the perfect match.</p>
    </div>
