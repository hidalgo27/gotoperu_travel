...
<!--      </div>-->
      <div class="absolute left-0 bottom-0 py-12 pl-12 pr-24 bg-gray-400 z-0 bg-gradient-to-t from-gray-800/50 bg-opacity-10 w-full">
...
<!--         Special Offers-->
        <div class="mt-4 border-t text-xs pt-3">
          <p>Contact our travel advisor to use this itinerary (or others) as a base to design together your perfect peruvian adventure!</p>
          <p><span class="font-semibold text-secondary">For Example:</span> add one day / reduce the program lenght / upgrades hotels / add all meals / upgrade to private tours</p>
