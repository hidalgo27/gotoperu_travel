...
`,
    text: "Custom vacations designed uniquely for you."
  },
  {
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="size-6">
...
`,
    text: "Round-the-clock support to ensure a flawless trip."
  },
  {
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="size-6">
...
`,
    text: "Knowledgeable local experts for your destinations."
  },
  {
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="size-6">
...
`,
    text: "Discover breathtaking adventures across South America, your way."
  },
  {
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="size-6">
...
`,
    text: "Luxury experiences with 5-star stays and private tours."
  }
];
...
<template>
  <section class="bg-primary bg-opacity-75 p-6 text-white justify-center flex flex-col items-center gap-6">
    ...
    <carousel :wrap-around="true" :breakpoints="breakpoints" class="w-full">
