      ...
      <div class="grid grid-cols-1 p-8 border-4 border-white">
        ...
        <div class="text-left mt-6">
            ...
            <div
              ...
              <div class="flex" v-for="destino in listDestination">
                ...
                <input type="checkbox" :id="destino.id" class="peer hidden" :value="destino.url"
                  v-model="packageStore.destination" />
                <label :for="destino.id"
                  class="w-full text-center gap-2 select-none cursor-pointer bg-gray-100 text-gray-800 rounded-full px-5 py-2 transition-colors duration-200 ease-in-out grayscale peer-checked:grayscale-0 peer-checked:bg-[#D6DD85] peer-checked:text-primary">
          ...
          <form @submit.prevent="handleSubmit">
            <h3 class="text-lg text-tertiary font-semibold text-center">HOTEL CATEGORY</h3>
            <h3 class="text-xs text-tertiary text-center">(OPTIONAL. You may choose more than one)</h3>
            <div class="grid grid-cols-12 gap-6 my-3 focus:touch-pan-x">
              <div
              ...
              <div class="col-span-12 md:col-span-10 grid grid-cols-3 gap-3 focus:touch-pan-x">
            ...
            <h3 class="text-lg text-tertiary font-semibold text-center mt-3 pt-2">NUMBER OF TRAVELERS</h3>
            <div class="grid grid-cols-12 gap-6 my-3 focus:touch-pan-x">
              <div
              ...
              <div class="col-span-12 md:col-span-10 grid grid-cols-7 gap-3 items-center ">
                <div class="flex items-center" v-for="n in 6" :key="n">
                  ...
                  <label :for="'radio_' + n"
                    class="w-full select-none cursor-pointer border border-gray-300 bg-white bg-fixed text-gray-400 rounded-lg text-center py-2 transition-colors duration-200 ease-in-out peer-checked:border-2 peer-checked:border-primary peer-checked:text-primary">
                    {{ n }} </label>
                </div>
                <div class="flex">
            ...
            <div class="grid grid-cols-12 gap-6 my-3  focus:touch-pan-x">
              ...
              <div class="col-span-12 md:col-span-10 grid grid-cols-3 md:grid-cols-6 gap-3  focus:touch-pan-x">
                <div class="flex">
                  <input type="checkbox" :id="'radio_t_1'" class="peer hidden" value="3-7" v-model="trip_length" />
                  <label :for="'radio_t_1'"
                    class="select-none leading-3 cursor-pointer w-full  bg-white bg-fixed  text-center text-gray-400 rounded-lg px-1 md:px-2 py-2 transition-colors duration-200 ease-in-out peer-checked:border-2 peer-checked:border-primary peer-checked:text-primary">
                ...
                <div class="flex">
                  ...
                  <label :for="'radio_t_2'"
                    class="select-none cursor-pointer w-full border bg-white bg-fixed  text-center leading-3 text-gray-400 rounded-lg px-1 md:px-2 py-2 transition-colors duration-200 ease-in-out peer-checked:border-2 peer-checked:border-primary peer-checked:text-primary">
                ...
                <div class="flex">
                  ...
                  <label :for="'radio_t_3'"
                    class="select-none cursor-pointer w-full border bg-white bg-fixed border-gray-300 text-center leading-3 text-gray-400 rounded-lg px-1 md:px-2 py-2 transition-colors duration-200 ease-in-out peer-checked:border-2 peer-checked:border-primary peer-checked:text-primary">
                ...
                <div class="flex ">
                  <input type="checkbox" :id="'radio_t_6'" class="peer hidden" value="Undecided"
                    v-model="trip_length" />
                  <label :for="'radio_t_6'"
                    class="my-auto h-full select-none cursor-pointer w-full border bg-white bg-fixed border-gray-300 text-center leading-3 text-gray-400 rounded-lg px-1 py-2 transition-colors duration-200 ease-in-out peer-checked:border-2 peer-checked:border-primary peer-checked:text-primary text-[10px] ">
                    Undecided</label>
                </div>
              </div>
            </div>
            ...
            <div class="relative mt-8">
              <div class="relative">
                <textarea type="text" name="search" class="is-input-ico pt-12 peer" placeholder=" " autocomplete="off"
                  v-model="comment" />
            ...
            <div class="flex justify-center mt-6">
              <button type="submit" class="btn-primary bg-orange-400" v-show="showLoader == false">Get Inquire</button>
