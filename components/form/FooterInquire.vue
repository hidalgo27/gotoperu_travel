          ...
          <div class="grid grid-cols-12 gap-6 my-3 overflow-x-scroll focus:touch-pan-x">
            ...
            <div class="col-span-12 md:col-span-10 grid grid-cols-7 gap-3">
              <div class="flex" v-for="n in 6" :key="n">
                ...
                <label :for="'radio_' + n"
                  class="w-full select-none cursor-pointer bg-gray-100 text-gray-800 rounded-lg text-center py-2 transition-colors duration-200 ease-in-out peer-checked:bg-primary peer-checked:text-white">
                  {{ n }} </label>
              </div>
          ...
          <div class="grid grid-cols-12 gap-6 my-3 overflow-x-scroll focus:touch-pan-x">
            ...
            <div
              ...
              <div class="flex">
                ...
                <label :for="'radio_t_1'"
                  class="select-none leading-3 cursor-pointer w-full border border-gray-300 text-center text-gray-400 rounded-lg px-1 md:px-2 py-2 transition-colors duration-200 ease-in-out peer-checked:border-2 peer-checked:border-primary peer-checked:text-primary">
              ...
              <div class="flex">
                ...
                <label :for="'radio_t_2'"
                  class="select-none cursor-pointer w-full border border-gray-300 text-center leading-3 text-gray-400 rounded-lg px-1 md:px-2 py-2 transition-colors duration-200 ease-in-out peer-checked:border-2 peer-checked:border-primary peer-checked:text-primary">
              ...
              <div class="flex">
                ...
                <label :for="'radio_t_6'"
                  class="select-none cursor-pointer w-full border border-gray-300 text-center leading-3 text-gray-400 rounded-lg px-1 py-2 transition-colors duration-200 ease-in-out peer-checked:border-2 peer-checked:border-primary peer-checked:text-primary text-[10px]">
                  Undecided</label>
              </div>
            </div>
          </div>
