...
<template>
  <div v-if="isOpen" class="fixed inset-0 flex items-center z-50 justify-center bg-gray-800 bg-opacity-50 scroll"
    ...
    <div
      class="bg-white md:rounded-lg shadow-lg md:w-auto lg:w-5/6 xl:w-2/3 2xl:w-1/2 h-screen md:h-auto relative overflow-y-auto sm:overflow-y-auto">
      ...
      <div class="flex flex-col md:flex-row items-center ">
        ...
        <form @submit.prevent="handleSubmit" class="flex-auto p-6 xl:p-10 text-xs">
          <!-- Botones de título -->
...
<div class="mt-4">
  ...
  <div v-if="$v.country.$error" class="text-xs text-red-500">Country required</div>
          ...
          <div class="flex justify-center mt-6 relative ">
            <button type="submit"
              class="btn-primary py-2 px-4 rounded shadow-md hover:bg-gray-100 hover:text-gray-700 w-full"
              v-show="showLoader == false">Join now</button>
...
.input-goto {
  @apply block w-full py-2 pl-12 border rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400;
}
